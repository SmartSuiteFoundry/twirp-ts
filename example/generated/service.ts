// @generated by protobuf-ts 2.11.1 with parameter client_none,generate_dependencies
...
class ListHatRPC$Type extends MessageType<ListHatRPC> {
    constructor() {
        super("twirp.example.haberdasher.ListHatRPC", [
            { no: 1, name: "filters", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Filter }
        ]);
    }
...
class Hat$Type extends MessageType<Hat> {
    constructor() {
        super("twirp.example.haberdasher.Hat", [
            ...
            { no: 5, name: "variants", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Hat }
        ]);
    }
